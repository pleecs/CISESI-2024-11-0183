...
const var"##bcs#475" = JLD2.load("data/em-data.jld2", "##bcs#475")
const var"##edg#442" = JLD2.load("data/em-data.jld2", "##edg#442")
const var"##edg#444" = JLD2.load("data/em-data.jld2", "##edg#444")
const var"##bcs#481" = JLD2.load("data/em-data.jld2", "##bcs#481")
const var"##mat#437" = JLD2.load("data/em-data.jld2", "##mat#437")
const var"##edg#484" = JLD2.load("data/em-data.jld2", "##edg#484")
const var"##edg#446" = JLD2.load("data/em-data.jld2", "##edg#446")
const var"##nod#440" = JLD2.load("data/em-data.jld2", "##nod#440")
const var"##edg#448" = JLD2.load("data/em-data.jld2", "##edg#448")
const var"##edg#450" = JLD2.load("data/em-data.jld2", "##edg#450")
const var"##edg#452" = JLD2.load("data/em-data.jld2", "##edg#452")
const var"##edg#454" = JLD2.load("data/em-data.jld2", "##edg#454")
const var"##edg#456" = JLD2.load("data/em-data.jld2", "##edg#456")
const var"##edg#458" = JLD2.load("data/em-data.jld2", "##edg#458")
const var"##nod#438" = JLD2.load("data/em-data.jld2", "##nod#438")
const var"##int#483" = JLD2.load("data/em-data.jld2", "##int#483")
const var"##edg#460" = JLD2.load("data/em-data.jld2", "##edg#460")
const var"##bcs#451" = JLD2.load("data/em-data.jld2", "##bcs#451")
const var"##edg#462" = JLD2.load("data/em-data.jld2", "##edg#462")
const var"##edg#464" = JLD2.load("data/em-data.jld2", "##edg#464")
const var"##edg#466" = JLD2.load("data/em-data.jld2", "##edg#466")
const var"##edg#468" = JLD2.load("data/em-data.jld2", "##edg#468")
const var"##edg#470" = JLD2.load("data/em-data.jld2", "##edg#470")
const var"##edg#472" = JLD2.load("data/em-data.jld2", "##edg#472")
const var"##edg#474" = JLD2.load("data/em-data.jld2", "##edg#474")
const var"##edg#476" = JLD2.load("data/em-data.jld2", "##edg#476")
const var"##edg#478" = JLD2.load("data/em-data.jld2", "##edg#478")
const var"##mat#439" = JLD2.load("data/em-data.jld2", "##mat#439")
const var"##edg#480" = JLD2.load("data/em-data.jld2", "##edg#480")
const var"##edg#482" = JLD2.load("data/em-data.jld2", "##edg#482")
...
function apply_electric_sources!()    
    apply_electric_source!(var"##edg#452", 0.5 * (15.5 * sin((2π) * 5.087e9 * state.time) * exp((-0.5 * (state.time - 5.0e-9) ^ 2) / 1.0e-9 ^ 2)))
end
